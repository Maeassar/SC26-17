  ...
  return (
    <div className="page narrow">
      ...
      <details className="console-card boundaries">
        <summary>
          <span>
            <span className="card-kicker">02 · GENERATION BOUNDARIES</span>
            <h2>计算与生成边界</h2>
          </span>
      ...
      <section className="console-card data-control">
        <div className="card-kicker">03 · LOCAL DATA</div>
        <h2>浏览器本地数据</h2>
        ...
        <div className="settings-actions">
          <button className="settings-text-action" type="button" onClick={onOpenPrivacy}>查看隐私说明</button>
          {!demoMode && <button
